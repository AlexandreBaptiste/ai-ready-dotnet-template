...
- Check `/docs/adr/` for existing ADRs to determine the next sequential 4-digit number
- File naming: `adr-NNNN-[title-slug].md` (e.g., `adr-0001-use-cqrs-with-mediatr.md`)
